...
/**********************************/
CREATE TABLE member(
		m.id                          		VARCHAR2(10)		 NOT NULL,
		m.password                    		VARCHAR2(10)		 NOT NULL,
		m.name                        		VARCHAR2(20)		 NOT NULL,
		m.phone                       		VARCHAR2(15)		 NULL ,
		m.birth                       		VARCHAR2(10)		 NULL ,
		m.email                       		VARCHAR2(50)		 NULL ,
		m.gender                      		VARCHAR2(10)		 NOT NULL,
		m.point                       		NUMBER(10)		 NULL 
);

DROP SEQUENCE member_m.id_SEQ;

CREATE SEQUENCE member_m.id_SEQ NOMAXVALUE NOCACHE NOORDER NOCYCLE;

COMMENT ON TABLE member is 'member';
COMMENT ON COLUMN member.m.id is 'm.id';
COMMENT ON COLUMN member.m.password is 'm.password';
COMMENT ON COLUMN member.m.name is 'm.name';
COMMENT ON COLUMN member.m.phone is 'm.phone';
COMMENT ON COLUMN member.m.birth is 'm.birth';
COMMENT ON COLUMN member.m.email is 'm.email';
COMMENT ON COLUMN member.m.gender is 'm.gender';
COMMENT ON COLUMN member.m.point is 'm.point';
...
COMMENT ON COLUMN productDetail.m.id is 'm.id';
...
COMMENT ON COLUMN QNA.m.id is 'm.id';
...
COMMENT ON COLUMN review.m.id is 'm.id';
...
COMMENT ON COLUMN wishList.m.id is 'm.id';
...
ALTER TABLE member ADD CONSTRAINT IDX_member_PK PRIMARY KEY (m.id);

ALTER TABLE address ADD CONSTRAINT IDX_address_PK PRIMARY KEY (a_no);
ALTER TABLE address ADD CONSTRAINT IDX_address_FK0 FOREIGN KEY (m.id) REFERENCES member (m.id);
...
ALTER TABLE productDetail ADD CONSTRAINT IDX_productDetail_FK3 FOREIGN KEY (m.id) REFERENCES member (m.id);

ALTER TABLE QNA ADD CONSTRAINT IDX_QNA_PK PRIMARY KEY (q_no);
ALTER TABLE QNA ADD CONSTRAINT IDX_QNA_FK0 FOREIGN KEY (m.id) REFERENCES member (m.id);
...
ALTER TABLE review ADD CONSTRAINT IDX_review_FK1 FOREIGN KEY (m.id) REFERENCES member (m.id);
...
ALTER TABLE wishList ADD CONSTRAINT IDX_wishList_FK1 FOREIGN KEY (m.id) REFERENCES member (m.id);
